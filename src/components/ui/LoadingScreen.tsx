    ...
    <AnimatePresence>
      {!loaded && (
        <motion.div
          ...
          className="absolute inset-0 z-[100] bg-background p-4 md:p-6 min-h-screen"
        >
          <div className="w-full relative h-[85vh] md:h-[85vh] min-h-[600px] md:w-[75%] mx-auto flex flex-col items-center justify-center pointer-events-none">
            <div className="relative z-20 text-center space-y-6 px-4 mt-51">
              <div className="inline-block">
                <h1 className="text-5xl md:text-8xl tracking-tighter text-mauve pb-2 drop-shadow-lg font-minecraft">
                  kryo
                </h1>
              </div>

              <div className="flex justify-center pt-4">
                <div className="w-[200px] h-[2px] bg-bg-elevated rounded-full overflow-hidden">
                  <motion.div
